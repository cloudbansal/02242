...
public class CodeLine {
	...
	public ReachingDefinitionsSet getInitialReachingDefinitions() {
		return initialReachingDefinitions;
	}

	public void setInitialReachingDefinitions(ReachingDefinitionsSet initialReachingDefinitions) {
		this.initialReachingDefinitions = initialReachingDefinitions;
	}

	public ReachingDefinitionsSet getFinalReachingDefinitions() {
		return finalReachingDefinitions;
	}
